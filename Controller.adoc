...
Each entity (except <<Model.adoc#department-manager, Department Manager>>) has it's own controller, mapped to the corresponding path. Depending on the entity, it is also possible
